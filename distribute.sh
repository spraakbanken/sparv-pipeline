...
line=$(head -n 1 annotate/VERSION)
...
ssh anne@k2.spraakdata.gu.se "cd /export/htdocs_sb/pub/sparv.dist/sparv_pipeline;
...
rm -r $DIR_MIT;
if [ -f $DIR_MIT.zip ]; then echo -e 'Distribution successful!\n'; else echo -e 'Something went wrong...\n'; fi;"
...
rm -r $DIR_AGPL;
if [ -f $DIR_AGPL.zip ]; then echo -e 'Distribution successful!\n'; else echo -e 'Something went wrong...\n'; fi;"
