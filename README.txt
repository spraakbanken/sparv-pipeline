...
The Sparv-Pipeline is a corpus annotation pipeline created by Språkbanken (http://spraakbanken.gu.se/).
The source code is made available under the MIT license (https://opensource.org/licenses/MIT).

Documentation can be found here:
http://spraakbanken.gu.se/eng/research/infrastructure/sparv
